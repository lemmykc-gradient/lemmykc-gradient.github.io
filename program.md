...
| 11:00 | 275 | **<span style="color: purple">WORKSHOP:</span> Unpacking "Safe" and "Responsible" AI** | **Qinghua Lu**, CSIRO<br>**Alexander Saeri**, MIT FutureTech | Responsible AI and AI Safety are often discussed together, but what is the relationship between these concepts and communities? In this session, we will provide an overview of recent progress in the science of Responsible AI, and provide space to discuss cross-pollination between Responsible AI and AI Safety research & practice communities. |
